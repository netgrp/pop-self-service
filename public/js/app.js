...
Vue.component('reset-request', __webpack_require__(35));
Vue.component('reset-password', __webpack_require__(39));
...
Component.options.__file = "resources\\assets\\js\\components\\ResetRequest.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2768b592", Component.options)
  } else {
    hotAPI.reload("data-v-2768b592", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_recaptcha__ = __webpack_require__(37);
//
//
//
//
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2768b592", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-73e7ba23", Component.options)
  } else {
    hotAPI.reload("data-v-73e7ba23", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    _c(
      ...
      [
        ...
        _vm.sendok
          ? _c("div", { staticClass: "alert alert-success" }, [
              _c("strong", [_vm._v("Success!")]),
              _vm._v(" " + _vm._s(_vm.submitText) + " er gennemført.\n\t    ")
            ])
          : _vm._e(),
        _vm._v(" "),
        _vm.sendok !== true
          ? _c("center", [
              _c("input", {
                ...
                class:
                  _vm.hasErrors || _vm.loading
                    ? "btn btn-secondary"
                    : "btn btn-primary",
                attrs: {
                  type: "submit",
                  disabled: _vm.hasErrors || _vm.loading
                },
